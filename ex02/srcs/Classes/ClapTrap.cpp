...
/*   Updated: 2024/08/14 17:51:06 by ibertran         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "\e[32mClaptrap\e[0m default constructor called" << std::endl;
}

ClapTrap::ClapTrap(const ClapTrap &other)
{
	std::cout 
		<< "\e[32mClaptrap\e[0m " << this->_name
...
void	ClapTrap::takeDamage(unsigned int amount)
{
		...
		this->_hitPts -= amount;
		if (!this->_hitPts)
			std::cout << "\e[32mClaptrap\e[0m " << this->_name << " had died..." << std::endl;
}
